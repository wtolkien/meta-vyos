...
SRC_URI = "git://github.com/vyos/vyatta-vrrp.git;branch=current;protocol=https \
	  "

# snapshot from Aug 14, 2017:
SRCREV = "9ef258c1b8e06ec2775242ef673c54674b0480ff"
...
DEPENDS = "vyos-bash"
RDEPENDS_${PN} = "perl vyos-cfg vyos-cfg-system vyos-op vyos-bash keepalived"
