SUMMARY = "VyOS zone-policy package"
HOMEPAGE = "https://github.com/vyos/vyatta-zone"
SECTION = "vyos/net"
...
SRC_URI = "git://github.com/vyos/vyatta-zone.git;branch=current;protocol=https \
	  "

# snapshot from Aug 10, 2017:
SRCREV = "99bc5b23bbc56a46b9c7f3974d10809f230a84d2"
...
DEPENDS = "vyos-bash"
RDEPENDS_${PN} = "perl vyos-bash vyos-cfg vyos-cfg-firewall"
